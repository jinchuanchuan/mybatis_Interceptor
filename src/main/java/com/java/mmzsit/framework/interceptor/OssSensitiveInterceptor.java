...
import com.java.mmzsit.framework.annotation.OssSensitive;
...
public class OssSensitiveInterceptor implements Interceptor {
...
//    private AliyunOssClient aliyunOssClient;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        log.info("进入OssSensitiveInterceptor拦截器：————————————————————————————————————");
        // 对请求参数进行截取
...
//            DefaultResultSetHandler originalObject = (DefaultResultSetHandler) metaObject.getOriginalObject();
//            Object[] args1 = invocation.getArgs();
//            Statement statement = (Statement) args1[0];
//            MappedStatement ms = (MappedStatement) args1[0];
//            Object parameterObject = args1[1];
//            BoundSql boundSql = ms.getBoundSql(parameterObject);
//            String origSql = boundSql.getSql();
//            log.info("ResultSetHandler对象信息：{}", JSON.toJSONString(invocation));
//            Object[] args = invocation.getArgs();
//            MappedStatement mappedStatement01 = (MappedStatement) args[0];
